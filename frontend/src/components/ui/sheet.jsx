...
const SheetOverlay = React.forwardRef(({ position = "fixed", className, ...props }, ref) => (
...
const sheetVariants = cva(
  "z-50 gap-4 bg-white p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 dark:bg-slate-950",
  {
    variants: {
      side: {
...
const SheetContent = React.forwardRef(({ side = "right", position = "fixed", className, container = null, children, ...props }, ref) => (
