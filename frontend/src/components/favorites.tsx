        ...
        {favorites.map((f, i) => (
            <Card key={i} className="flex items-center space-x-3 my-4 pb-3">
                <div className="flex-1 flex justify-center">
                    <Image src={"http://localhost:1337" + f.variant.Images?.data[0].attributes.formats?.thumbnail.url} width={f.variant.Images?.data[0].attributes.formats?.thumbnail.width} height={f.variant.Images?.data[0].attributes.formats?.thumbnail.height} alt="Immagine di prodotto" />
                </div>
