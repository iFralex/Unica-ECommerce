...
export const WhatIs = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center p-4">
            <div className="flex flex-col items-center w-full uppercase overflow-visible">
                {/* Largest circular card at the top */}
                <BlurFade delay={0.5} inView className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg mb-4">
